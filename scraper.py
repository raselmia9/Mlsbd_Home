...
import cloudscraper
from bs4").BeautifulSoup as BeautifulSoup  # standard import fix below

# MLSBD URL
BASE_URL = "https://mlsbd.co/"
MAX_PAGES = 20  # আপনার নির্দেশ অনুযায়ী ২০টি পেজ
...
def scrape_mlsbd():
    print(f"🟢 [INFO] Scraping started at: {datetime.now().strftime('%Y-%m-%d %H:%M:%S')}")
    ...
    try:
        ...
        for page_num in range(1, MAX_PAGES + 1):
            ...
            # হোমপেজ বা পেজের সমস্ত পোস্ট বা কার্ডগুলো খুঁজে বের করা (আপনার পুরানো লজিক)
            ...
            print(f"🟢 [SUCCESS] Collected {page_items_count} items from page {page_num}. Total unique items: {len(movies_data)}")
            success_pages += 1
        ...
        # ২. উন্নত স্ট্যাটাস ফাইল তৈরি করা (কোনো ডেট/টাইম ছাড়াই সবুজ ডট সহ)
